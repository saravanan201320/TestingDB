...
var RXHDPageControllers = angular.module('RXHDPageControllers',['googlechart','angular.filter']);

RXHDPageControllers.controller('RXHDPageController', function($scope,$http,$filter){
  $scope.ASGNames =[];
